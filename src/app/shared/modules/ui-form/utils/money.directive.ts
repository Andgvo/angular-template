...
/**
 * Project: ngx-currency-input https://github.com/filipows/ngx-currency-input
 * Copyright (c) 2020 Chris Filipowski
 * License (MIT) https://github.com/filipows/ngx-currency-input/blob/master/LICENSE
 */
@Directive({
  selector:
...
export class MoneyDirective implements ControlValueAccessor, Validator, OnInit{
  ...
  validate(control: AbstractControl): ValidationErrors | null{
    ...
    if (this.min !== undefined && control.value < this.min) {
      errors.min = true;
    }

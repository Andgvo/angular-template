...
export const ROUTE_TABLE = new AppRoute('Table', undefined , 'table', ROUTE_APP, 'template');

export const CARDS_HOME = Card.mapToCard([
    { appRoute: ROUTE_APP, description: 'Home'},
    { appRoute: ROUTE_CUSTOM_THEME, description: 'Define de colors theme'},
    { appRoute: ROUTE_BREADCRUMB, description: 'Componet with breadcrum and current page title'},
    { appRoute: ROUTE_BUTTONS, description: 'Extra custom colored buttons'},
